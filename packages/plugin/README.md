...
This document will provide simple webpack configuration. you should check the <a href="https://yaba.io/docs/getting-started" target="_blank">documentation</a> for further details.
